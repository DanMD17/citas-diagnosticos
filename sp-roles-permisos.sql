...
BEGIN
    insert into tbl_roles_permisos(tbl_roles_rol_id,tbl_permisos_id_per, per_rol_fecha_asignacion) 
    values(p_rol_id,p_permiso_id,p_date);
END//
DELIMITER ;
...
begin
    ...
    set tbl_roles_rol_id = p_fkrol, tbl_permisos_id_per = p_fkpermiso, per_rol_fecha_asignacion = p_date
